...
uv run examples/dexora/convert.py \
  --data-dir \
  "/qiyuan_research_vepfs_001/weiyi/huggingface/lerobot/weiyi/dexora_dataset/dexora" \
  --REPO-NAME weiyi/dexora_close_open_drawer